...
// component responds to clicks (opening the drawer). Note that the
// ACTUAL data-reading (getCategories) already happened on the server,
// in layout.tsx - this component just receives the finished result
// as a prop and displays it. This split (server fetches, client
// displays) is a common and important Next.js pattern.
