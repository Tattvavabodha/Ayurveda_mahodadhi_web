...
export default async function RootLayout({
  ...
  // Fetched ONCE here, at the top of every page render, and passed
  // down - so every page (homepage today, chapter pages later) shares
  // the exact same navigation data, read live from the content
  // repository's actual folders.
